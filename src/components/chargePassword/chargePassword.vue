<template>
  <div class="chargePassword">
    <div class="header">
      <div class="icon_left" @click="back()">
        <img src="../../assets/public_back.png" alt="icon"/>
      </div>
      <div class="text_con">修改密码</div>
      <div class="icon_right">
      </div>
    </div>
    <div class="content">
      <div class="back_cv">
        <div class="leuoj">修改密码</div>
        <div class="cflp">
        ...
        <div class="pasfm">
          ...
          <input type="password" placeholder="密码由字母和数字组成(6-18位)" class="ipt" v-model="new_password">
        </div>
        <div class="pasfm">
          <div class="pasfm1">重复密码</div>
          <input type="password" placeholder="请再次输入新密码" class="ipt" v-model="re_new_password">
        </div>
      </div>
